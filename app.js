...
const CLINICAL_LOCATION_OPTIONS = {
  ...
  CHIAPAS: ["TAPACHULA", "TUXTLA GUTIÉRREZ"],
  ...
  NAYARIT: ["TEPIC"],
  "NUEVO LEÓN": ["GUADALUPE", "MONTERREY"],
  ...
  SINALOA: ["CULIACÁN", "GUASAVE", "NAVOLATO", "SALVADOR ALVARADO"],
  SONORA: ["AGUA PRIETA", "HERMOSILLO", "NACOZARI DE GARCÍA", "NAVOJOA", "SAN LUIS RÍO COLORADO"],
  TABASCO: ["CÁRDENAS", "CENTRO"],
  TAMAULIPAS: ["REYNOSA", "TAMPICO"],
